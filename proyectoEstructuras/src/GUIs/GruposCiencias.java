...
public class GruposCiencias extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GruposCiencias
     */
    public GruposCiencias() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Reporte Matriculas - Grupos Ciencias");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposCiencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GruposCiencias().setVisible(true);
            }
        });
    }

    public void copiarMatriculasMatuC() {

        if (!Rutinas.estaDCVacia()) {

            NodoDC aux = inicioDC;
            Rutinas.encolarMatuC(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
    ...
    public void copiarMatriculasVesperC() {

        if (!Rutinas.estaDCVacia()) {

            NodoDC aux = inicioDC;
            Rutinas.encolarVespeC(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
    ...
    public void copiarMatriculasNocC() {

        if (!Rutinas.estaDCVacia()) {

            NodoDC aux = inicioDC;
            Rutinas.encolarNoC(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
    ...
    public void mostrarColaMatuCTbl() {

        NodoC aux = Rutinas.inicioCMatuC;
    ...
    public void mostrarColaVesperCTbl() {

        NodoC aux = Rutinas.inicioCVesperC;
    ...
    public void mostrarColaNocCTbl() {
        NodoC aux = Rutinas.inicioCNoC;
