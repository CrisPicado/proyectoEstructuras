 ...
 * @author Cris Picado
 */
public class ListadoEstudiantesC extends javax.swing.JFrame {

    RegistroCursoC r = new RegistroCursoC();
    ...
    /**
     * Creates new form ListadoEstudiantesC
     */
    public ListadoEstudiantesC() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Listado Estudiantes - Matricula Ciencias");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista Estudiantes - Curso Ciencias:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoEstudiantesC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoEstudiantesC().setVisible(true);
            }
        });
    }
