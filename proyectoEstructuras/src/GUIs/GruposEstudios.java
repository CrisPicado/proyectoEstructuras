 ...
 * @author Cris Picado
 */
public class GruposEstudios extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GruposVespeMat
     */
    public GruposEstudios() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Reporte Matriculas - Grupos Estudios Sociales");
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        if (cbxHorarios.getSelectedItem().equals("Matutino")) {
            lblTitulo.setText("Reporte Matriculas - Grupos Matutinos");
            copiarMatriculasMatuES();
        } else if (cbxHorarios.getSelectedItem().equals("Vespertino")) {
            lblTitulo.setText("Reporte Matriculas - Grupos Vespertinos");
            copiarMatriculasVespeES();
        } else if (cbxHorarios.getSelectedItem().equals("Nocturno")) {
            lblTitulo.setText("Reporte Matriculas - Grupos Nocturnos");
            copiarMatriculasNocES();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposEstudios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GruposEstudios().setVisible(true);
            }
        });
    }

    public void copiarMatriculasMatuES() {

        if (!Rutinas.estaLDVacia()) {

            NodoLD aux = inicioLD;
            Rutinas.encolarMatuES(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
    ...
    public void copiarMatriculasVespeES() {

        if (!Rutinas.estaLDVacia()) {

            NodoLD aux = inicioLD;
            Rutinas.encolarVespES(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
            ...
            JOptionPane.showMessageDialog(null, "Estudiantes con matricula vespertina encolados!");
    ...
    public void copiarMatriculasNocES() {

        if (!Rutinas.estaLDVacia()) {

            NodoLD aux = inicioLD;
            Rutinas.encolarNocES(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
    ...
    public void mostrarColaMatuESTbl() {

        NodoC aux = Rutinas.inicioCMatuES;
    ...
    public void mostrarColaVesperESTbl() {

        NodoC aux = Rutinas.inicioCVesperES;
    ...
    public void mostrarColaNocESTbl() {
        NodoC aux = Rutinas.inicioCNocES;
