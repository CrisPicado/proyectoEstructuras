 ...
 * @author Cris Picado
 */
public class GruposEspanol extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GruposEspanol
     */
    public GruposEspanol() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Reporte Matriculas - Grupos Español");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposEspanol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GruposEspanol().setVisible(true);
            }
        });
    }
    
    public void copiarMatriculasMatuE() {

        if (!Rutinas.estaSCVacia()) {

            NodoSC aux = inicioSC;
            Rutinas.encolarMatuE(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
    ...
    public void copiarMatriculasVesperE() {

        if (!Rutinas.estaSCVacia()) {

            NodoSC aux = inicioSC;
            Rutinas.encolarVespE(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
    ...
    public void copiarMatriculasNocE() {

        if (!Rutinas.estaSCVacia()) {

            NodoSC aux = inicioSC;
            Rutinas.encolarNocE(aux.getElemento().getNumCedula(), aux.getElemento().getNombre(), aux.getElemento().getApePaterno(), aux.getElemento().getApeMaterno(), aux.getElemento().getContacto(), aux.getElemento().getCorreo(), aux.getElemento().getTipoHorario(), aux.getElemento().getHorario());
            aux = aux.getSiguiente();
    ...
    public void mostrarColaMatuETbl() {

        NodoC aux = Rutinas.inicioCMatuE;
    ...
    public void mostrarColaVesperETbl() {

        NodoC aux = Rutinas.inicioCVesperE;
    ...
    public void mostrarColaNocETbl() {
        NodoC aux = Rutinas.inicioCNocE;
